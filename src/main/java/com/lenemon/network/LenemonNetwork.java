...
public class LenemonNetwork {
    ...
    public static void register() {
        ...
        PayloadTypeRegistry.playS2C().register(PacketHudBattle.ID, PacketHudBattle.CODEC);
        ...
        // Pokedex payloads
        PayloadTypeRegistry.playS2C().register(PokedexOpenPayload.ID, PokedexOpenPayload.CODEC);
